          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
              <li class="breadcrumb-item text-muted">
                <a href="" class="text-muted">Manage Time Slots</a>
              </li>
              <li class="breadcrumb-item text-muted">
                <a href="" class="text-muted">Add Time Slots</a>
              </li>
            </ul>
            <!--end::Breadcrumb-->
          </div>
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Time-Slots Add Form
                <i class="mr-2"></i>
            ...
            <div class="card-toolbar">
              ...
              <div class="btn-group">
                <a href="{{ route('time_slots.store') }}"  onclick="event.preventDefault(); document.getElementById('time_slots_add_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            {{ Form::open([ 'route' => 'time_slots.store','class'=>'form' ,"id"=>"time_slots_add_form", 'enctype'=>'multipart/form-data']) }}
              @csrf
              <div class="row">
                ...
                <div class="col-xl-8">
                  <div class="my-5">
                    ...
                    <div class="form-group row {{ $errors->has('time_slot') ? 'has-error' : '' }}">
                      ...
                      <div class="col-9">
                        {{ Form::time('time_slot', null, ['class' => 'form-control form-control-solid','id'=>'time_slot','placeholder'=>'Enter time_slot','required'=>'true']) }}

        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            <div class="card-title">
              <h3 class="card-label">Discount Edit Form
                <i class="mr-2"></i>
            ...
            <div class="card-toolbar">
              ...
              <div class="btn-group">
                <a href=""  onclick="event.preventDefault(); document.getElementById('discount_update_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            {{ Form::model($discount, [ 'method' => 'PATCH','route' => ['discounts.update', $discount->id],'class'=>'form' ,"id"=>"discount_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
